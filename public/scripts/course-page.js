...
window.addEventListener('load', async () => {
    ...
    courseTeacherSectionMobile.innerHTML = `
        <div class="w-full flex justify-center items-center gap-x-2.5 mb-3.5 pb-5 border-b lg:border-none border-b-gray-100 dark:border-b-darkSlate">
            <img src="http://localhost:4000${course.creator.profile}" alt="${course.creator.name}" class="block w-[60px] h-[60px] object-cover rounded-full">
            <div>
    ...
    courseTeacherSectionDesktop.innerHTML = `
        <img src="http://localhost:4000${course.creator.profile}" alt="${course.creator.name}" class="block w-[90px] h-[90px] mb-2 object-cover rounded-full">
    ...
    if (courseComments.length) {
        courseComments.forEach(comment => {
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-x-2">
                                        <img src="http://localhost:4000${comment.answerContent.creator.profile}" alt="${comment.answerContent.creator.name}" class="block md:hidden w-10 h-10 object-cover rounded-full shrink-0">
                                        <div class="shrink-0">
                                            <!--username-->
            ...
            <div class="flex gap-x-5 p-3.5 md:p-5 bg-gray-100 dark:bg-darkGray-700 rounded-2xl">
                ...
                <div class="hidden md:flex flex-col items-center gap-y-2">
                    <img src="http://localhost:4000${comment.creator.profile}" alt="${comment.creator.name}" class="block w-10 h-10 md:w-[60px] md:h-[60px] object-cover rounded-full">
                ...
                <div class="w-full">
                    ...
                    <div class="w-full flex justify-between items-center">
                        <!--username && date && profile and role for mobile size-->
                        <div class="flex items-center gap-x-2">
                            <img src="http://localhost:4000${comment.creator.profile}" alt="${comment.creator.name}" class="block md:hidden w-10 h-10 object-cover rounded-full shrink-0">
                            <div class="shrink-0">
                                <!--username-->
                                <span class="font-danaMedium text-base md:text-xl dark:text-white">
